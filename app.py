...
# Import mô-đun chấm công riêng biệt
from cham_cong import render_quan_ly_cham_cong
...
def render_dashboard():
    ...
    # Đọc danh sách cán bộ dùng chung cho các mô-đun
    ...
    if "Trang chủ / Dashboard" in menu_choice:
        ...
        # Gọi hàm render mô-đun chấm công từ file cham_cong.py
        render_quan_ly_cham_cong(df_cb)
    else:
